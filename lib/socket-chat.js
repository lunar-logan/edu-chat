                ...
                models.GroupMember.findAll({
                    ...
                    if (members) {
                        members.forEach(function (member) {
                            if (member in onlineUsers && member !== message.fromUser) {
                                // Send message to all the members except the one who sent it
                                message['fromUser'] = message.toUser;
                                onlineUsers[member].emit('private message', message);
                            } else {
                                console.log(colors.yellow('User: ' + member + ' is not online at the moment'));
                            }
                        });
                    } else {
