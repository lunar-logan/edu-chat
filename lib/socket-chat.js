...
function socketChat(io) {
    ...
    io.on('connection', function (socket) {
        ...
        /**
         * Emits the event if somebody is found writing
         * TODO: Is broadcasting this event safe? Does this poses some vulnerability?
         */
        ...
        socket.on('private message', function (message) {
            console.log(colors.blue("Private message received: " + JSON.stringify(message)));
            ...
            libChat.addPrivateMessage(message, function (insertedId) {
                if (insertedId) {
                    console.log(colors.green("Message inserted with id: " + insertedId));
                }
            });
        ...
        socket.on('disconnect', function () {
            ...
            Object.keys(onlineUsers).forEach(function (name) {
                if (onlineUsers[name] === socket) {
                    ...
                    console.log(colors.blue('Deleted socket object for user: "' + name + '"'));
                }
            });
        });
